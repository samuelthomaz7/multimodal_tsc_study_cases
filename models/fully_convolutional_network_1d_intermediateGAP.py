...
class FullyConvolutionalNetwork1DIntermediateGAP(NNModel):
    ...
    def __init__(self, dataset_name, train_dataset, test_dataset, metadata, model_name = 'FullyConvolutionalNetwork1DIntermediateGAP', random_state=42, device='cuda', is_multimodal=True) -> None:
