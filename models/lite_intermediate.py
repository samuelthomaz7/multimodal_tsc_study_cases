...
class LITEIntermediate(NNModel):

    def __init__(self, dataset_name, train_dataset, test_dataset, metadata, model_name = 'LITEIntermediate', random_state=42, device='cuda', is_multimodal=True, is_ensemble=True, model_num=None) -> None:
