...
class FullyConvolutionalNetwork1DLateGAP(NNModel):
    
    # def __init__(self, train_dataloader, test_dataloader, metadata, model_name = 'FullyConvolutionalNetwork1DLateGAP', random_state=42) -> None:
    #     super().__init__(train_dataloader, test_dataloader, metadata, 'FullyConvolutionalNetwork1DLateGAP', random_state, True)

    def __init__(self, dataset_name, train_dataset, test_dataset, metadata, model_name = 'FullyConvolutionalNetwork1DLateGAP', random_state=42, device='cuda', is_multimodal=True) -> None:
